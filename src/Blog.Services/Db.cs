...
{
    // cd C:\Git\Blog\Blog\src\Blog.Services>
    // dotnet ef migrations add x  CASE SENSITIVE
    // dotnet ef database update 
    /*
      
    comment this in project.json in frameworks
    "netstandard1.5": {
      "imports": [ "dnxcore50", "portable-net45+win8" ]
    },  


    add this to project.json in frameworks
    "netcoreapp1.0": {
